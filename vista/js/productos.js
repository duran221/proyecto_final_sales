...
new class Producto {
    ...
    constructor() {
        ...
        this.columnas = [ // este array de objetos define las columnas de la tabla
            ...
            { title: 'Presentación', field: 'presentacion', width: 150 },
            { title: 'Nombre', field: 'nombre', width: 150 },
            { title: 'Iva', field: 'porcentaje_iva', width: 150 },
            { title: 'Precio', field: 'precio', align: 'right', formatter: "money",width:100 },
            { title: 'Disponible', field: 'cantidad_disponible', align: 'center', width:120 },
            { title: 'Mínimo', field: 'cantidad_minima', align: 'center', width: 100 },
            { title: 'Máximo', field: 'cantidad_maxima', align: 'center', width: 100}
        ];

        this.ordenInicial = [ // establece el orden inicial de los datos
            { column: 'precio', dir: 'desc' }
        ]
    ...
    insertarRegistro() {
        ...
        let nuevoProducto = {
            presentacion: lstPresentacion.value,
            categoria: lstCategorias.value,
    ...
    editarRegistro() {
        ...
        $('#producto-txtiva').value = this.filaActual.getData().porcentaje_iva;
    ...
    eliminarRegistro() {
        ...
        MaterialDialog.dialog(
            "Va a eliminar un producto, por favor confirme la accion",{
                title:"Cuidado",
                dismissible: false,
                buttons:{
                    close:{
                        className:"red",text:"Cancelar"
                    },
                    confirm:{
                        className:"blue",
                        text: "Confirmar",
