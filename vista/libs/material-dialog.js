...
export class MaterialDialog {
    ...
    static dialog(text = '', options = {}) {
        ...
        let closeButtonClass = 'red darken-4';
        let modalClose = 'modal-close close';

        let confirmButtonText = 'Confirm';
        let confirmButtonClass = 'teal';
        let modalCloseConfirm = 'modal-close confirm';

        if (typeof(options.buttons) != 'undefined') {

            if (typeof(options.buttons.close) != 'undefined') {
                closeButtonText = typeof(options.buttons.close.text) != 'undefined' ? options.buttons.close.text : closeButtonText;
                closeButtonClass = typeof(options.buttons.close.className) != 'undefined' ? options.buttons.close.className : closeButtonClass;
            ...
            if (typeof(options.buttons.confirm) != 'undefined') {
                confirmButtonText = typeof(options.buttons.confirm.text) != 'undefined' ? options.buttons.confirm.text : confirmButtonText;
                confirmButtonClass = typeof(options.buttons.confirm.className) != 'undefined' ? options.buttons.confirm.className : confirmButtonClass;
