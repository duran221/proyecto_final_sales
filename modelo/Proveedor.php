...
class Proveedor implements Persistible{
    ...
    /**
     * Devuelve una cadena JSON que contiene el resultado de seleccionar todos los proveedores guardados
    ...
    /**
     * Inserta un registro de proveedor en la base de datos
     */
    public function insertar($param) {
        extract($param);
        // error_log(print_r($param, TRUE)); // quitar comentario para ver lo que se recibe del front-end

        $sql = "INSERT INTO proveedores VALUES (:id_proveedor, :nombre,:telefono, :correo)";
        ...
        if ($instruccion) {
            ...
            echo json_encode(['ok' => FALSE, 'mensaje' => 'Falló en la instrucción de inserción para proveedores']);
        }
    }

    /**
     * Inserta un registro de proveedores en la base de datos
     */
    public function actualizar($param) {
        ...
        if ($instruccion) {
            ...
            echo json_encode(['ok' => FALSE, 'mensaje' => 'Falló en la instrucción de actualización para proveedores']);
        }
    }
    ...
    public function eliminar($param) {
        ...
        if ($instruccion) {
            ...
            echo json_encode(['ok' => FALSE, 'mensaje' => 'Falló en la eliminación de proveedores']);
        }
    }
