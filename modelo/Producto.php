...
class Producto implements Persistible{
    ...
    public function insertar($param) {
        ...
        if ($instruccion) {
            //Asociando los datos que recibimos del fronted a los apuntadores para realizar la consulta sql:
            ...
            //Si la ejecución se ha realizado con éxito:
            if ($instruccion->execute()) {
                //fetch recupera un solo registro en forma de un array asociativo:
